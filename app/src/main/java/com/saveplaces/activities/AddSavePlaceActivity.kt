...
import com.saveplaces.utils.GetAddressFromLatLng
import com.karumi.dexter.Dexter
import com.karumi.dexter.MultiplePermissionsReport
import com.karumi.dexter.PermissionToken
import com.karumi.dexter.listener.PermissionRequest
import com.karumi.dexter.listener.multi.MultiplePermissionsListener
import kotlinx.android.synthetic.main.activity_add_save_place.*
import java.io.File
...
class AddSavePlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var mSavePlaceDetails: SavePlaceModel? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_save_place)
        ...
        if (mSavePlaceDetails != null) {
            supportActionBar?.title = "Edit Save Place"

            et_title.setText(mSavePlaceDetails!!.title)
            et_description.setText(mSavePlaceDetails!!.description)
            et_date.setText(mSavePlaceDetails!!.date)
            et_location.setText(mSavePlaceDetails!!.location)
            mLatitude = mSavePlaceDetails!!.latitude
            mLongitude = mSavePlaceDetails!!.longitude

            saveImageToInternalStorage = Uri.parse(mSavePlaceDetails!!.image)
                ...
                try {
                    ...
                    val intent =
                            Autocomplete.IntentBuilder(AutocompleteActivityMode.FULLSCREEN, fields)
                                    .build(this@AddSavePlaceActivity)
            ...
            R.id.btn_save -> {
                ...
                when {
                    ...
                    saveImageToInternalStorage == null -> {
                        ...
                        val savePlaceModel = SavePlaceModel(
                                if (mSavePlaceDetails == null) 0 else mSavePlaceDetails!!.id,
                        ...
                        if (mSavePlaceDetails == null) {
                            val addSavePlace = dbHandler.addSavePlace(savePlaceModel)
                            ...
                            val updateSavePlace = dbHandler.updateSavePlace(savePlaceModel)

                            if (updateSavePlace > 0) {
                                setResult(RESULT_OK);
                                finish()//finishing activity
                            }
                        }
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddSavePlaceActivity, "Failed!", Toast.LENGTH_SHORT)
                                .show()
                    }
                }
    ...
    /**
     * A function to save a copy of an image to internal storage for SavePlaceApp to use.
     */
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            // START
            val addressTask =
                    GetAddressFromLatLng(this@AddSavePlaceActivity, mLatitude, mLongitude)
