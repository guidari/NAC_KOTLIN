...
class MapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mSavePlaceDetails != null) {
            ...
            supportActionBar!!.title = mSavePlaceDetails!!.title
    ...
    override fun onMapReady(googleMap: GoogleMap) {
         ...
         */
        val position = LatLng(
                mSavePlaceDetails!!.latitude,
                mSavePlaceDetails!!.longitude
        )
        googleMap.addMarker(MarkerOptions().position(position).title(mSavePlaceDetails!!.location))
